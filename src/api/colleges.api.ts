import type { College, CollegeInclude } from "../types/college.types";
...
export function getCollege(id: number | string, include?: CollegeInclude[], signal?: AbortSignal) {
  return apiGet<ApiItemResponse<College>>(`/colleges/${id}${buildIncludeQuery(include)}`, signal);
}
